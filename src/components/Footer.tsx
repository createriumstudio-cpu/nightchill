        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/chat" className="text-sm text-gray-500 hover:text-orange-400 transition-colors">コンシェルジュ</Link></li>
          ...
          {/* Social */}
          <div>
            <h3 className="text-sm font-semibold text-gray-300 mb-3">SNS</h3>
            <div className="flex space-x-4">
              <a href="https://x.com/nightchill_date" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-orange-400 transition-colors" aria-label="X (Twitter)">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
              </a>
              <a href="https://www.instagram.com/nightchill_date" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-orange-400 transition-colors" aria-label="Instagram">
